...
function rowToSheet(r) {
  ...
  return {
    ...
    // Live field check-off state (synced across iPads).
    checkedProducts: d.checkedProducts || [],
    currentTank: d.currentTank || 1,
...
function sheetToRow(s) {
  return {
    ...
    data: {
      ...
      checkedProducts: s.checkedProducts || [],
      currentTank: s.currentTank || 1,
    },
