...
const RATES = {
  ...
  // herbicides
  prodiamine: '0.5–0.75 oz/M (spring)', dithiopyr: '0.25–0.5 oz/M', pendimethalin: 'per label', oxadiazon: 'per label', indaziflam: 'per label', '2,4-d': 'per label (3-way)', halosulfuron: '0.45–0.9 oz/M', sulfentrazone: 'per label',
  // PGRs
...
function rules(soil) {
  return [
    ...
    { cat: 'pgr', target: 'Growth regulation', surfaces: ['greens', 'tees', 'fairways', 'approaches'], sched: { start: '05-05', end: '10-10', gddStep: { base: 32, target: 360, fallback: 14 } }, chemistry: 'Trinexapac (Primo) — reapply on ~200 GDD (base 0°C / 360 GDD base 32°F)', product: 'PGR (trinexapac)', actives: ['trinexapac', 'paclobutrazol', 'flurprimidol'], reason: 'GDD-timed PGR: reapply every ~200 GDD (base 0°C) so regulation never rebounds — intervals tighten to ~8 days in summer heat and stretch to ~2 weeks in spring/fall. On sand greens improves density, cuts clippings and firms surfaces.', source: 'Kreuser/Soldat GDD model.' },
  ]
}
