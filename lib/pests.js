...
export const PEST_WATCH = [
  { id: 'fall_armyworm', label: 'Fall armyworm', months: [7, 10], window: 'Late Jul – Oct',
    ...
    action: 'Treat while caterpillars are small — they strip turf fast.',
    source: 'University of Maryland Extension — fall armyworm active late Jul–Oct in MD.' },
  { id: 'white_grub', label: 'White grubs', months: [8, 10], window: 'Late Aug – Oct (curative)',
    ...
    action: 'The curative window is late Aug–Sept, while grubs are small and feeding near the surface.',
    source: 'University of Maryland Extension — grub curative timing ~September.' },
  { id: 'chinch_bug', label: 'Chinch bugs', months: [6, 9], window: 'Jun – Sept',
    ...
    action: 'Spot-treat the hot, dry, sunny areas where damage shows.',
  ...
  { id: 'cutworm_webworm', label: 'Cutworms & sod webworms', months: [5, 9], window: 'May – Sept',
    ...
    action: 'Treat small larvae in the evening, when they surface.',
    source: 'Rutgers / University of Maryland — soap-flush scouting.' },
  { id: 'abw', label: 'Annual bluegrass weevil', months: [4, 8], window: 'Apr – Aug (multiple gens)',
    ...
    action: 'Time sprays to adults (early) or small larvae; later generations damage into summer.',
    source: 'Rutgers / Cornell turf entomology.' },
  { id: 'billbug', label: 'Bluegrass billbug', months: [4, 7], window: 'Spring – early summer',
    ...
    action: 'Target adults in spring, before eggs are laid.',
  ...
  { id: 'crabgrass', label: 'Crabgrass (pre-emergent)', months: [3, 4], window: 'Early spring',
    ...
    action: 'Pre-emergent herbicide down at or just before forsythia bloom.',
