...
const NUMERIC_FIELDS = new Set(['rate', 'labelMinM', 'labelMaxM', 'labelMinA', 'labelMaxA', 'stock', 'lowStockThreshold', 'n', 'p', 'k', 'nPerGal', 'pPerGal', 'kPerGal', 'activePct', 'ozPerCase', 'costPerCase'])
